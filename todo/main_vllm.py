...
# Connecte-toi à ton serveur vLLM local
USE_VLLM = os.getenv("USE_VLLM", "False").lower() == "true"

if USE_VLLM:
    client = OpenAI(base_url=os.getenv("VLLM_URL", "http://localhost:8001/v1"), api_key="EMPTY")
else:
...
""".strip()
    ...
    model="mistral",  # le nom est libre, mais doit correspondre à ton modèle vLLM
    messages=[
        {"role": "system", "content": "You are an AI crisis assistant."},
